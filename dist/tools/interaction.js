...
export async function handle(name, args) {
    switch (name) {
        ...
        case 'type': {
            const body = { id: args.tabId, text: args.text };
            if (args.selector)
                body.selector = args.selector;
        ...
        case 'hover_and_click': {
            const body = { id: args.tabId, clickText: args.clickText };
            if (args.hoverSelector)
                body.hoverSelector = args.hoverSelector;
            if (args.hoverText)
                body.hoverText = args.hoverText;
            if (args.waitMs !== undefined)
                body.waitMs = args.waitMs;
